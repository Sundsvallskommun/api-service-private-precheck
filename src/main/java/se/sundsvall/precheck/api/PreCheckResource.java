...
public class PreCheckResource {
    ...
    private static final Logger LOGGER = Logger.getLogger(PreCheckResource.class.getName());
    ...
    public ResponseEntity checkPermit(
        ...
        LOGGER.info(String.format("Checking permit for partyId: %s, municipalityId: %s, assetType: %s", partyId, municipalityId, assetType));
