...
public class Constants {
    ...
    public static final String NOT_FOUND_ERROR_MESSAGE = "Citizen data for '%s' was not given or had no content during execution of the service"; //TODO Better error message
    public static final String CORRECT_ADDRESS_TYPE = "POPULATION_REGISTRATION_ADDRESS";
    public static final String NO_VALID_MUNICIPALITY_ID_FOUND = "The owner of the partyId given is not register in the municipality where the permit is requested";
